<ul class="agenda__legende">
    ...
    <li><span class="agenda__categorie agenda__categorie_atelier"></span> Atelier/veillée</li>
    <li><span class="agenda__categorie agenda__categorie_temoignage"></span> Témoignage/conférence</li>
    <li><span class="agenda__categorie agenda__categorie_recherche"></span> Recherche/écriture</li>
